...
ImageButton1.Size = UDim2.new(0, 100, 0, 100)
ImageButton1.Draggable = true
ImageButton1.Image = "http://www.roblox.com/asset/?id=16799635923"
...
do local GUI = game.CoreGui:FindFirstChild("SOMEXHUB");if GUI then GUI:Destroy();end;if _G.Color == nil then
    _G.Color = Color3.fromRGB(247, 255, 0)
   end 
end
...
function Update:Window(text,logo,keybind)
    ...
    Hub.Text = "        "
    Hub.TextColor3 = Color3.fromRGB(247, 255, 0)   
    Hub.TextSize = 20.000
...
local LogoHub = Instance.new("ImageLabel")
    ...
    LogoHub.Image = "http://www.roblox.com/asset/?id="..tostring(16799635923)
...
Page.Size = UDim2.new(0, 500, 0, 500)
Page.Image = "http://www.roblox.com/asset/?id=" .. tostring(16799633484)
...
local LogoToggle = Instance.new("ImageLabel")
    ...
    LogoToggle.Image = "http://www.roblox.com/asset/?id="..tostring(16799635923)
...
local H = Library:AddTab("Inicio","6026568198")
local Main = Library:AddTab("Cày Level","13075651575")
local M = Library:AddTab("Item E Quest","13075622619")
local Ss = Library:AddTab("Trạng thái","7040410130")
local RaceV4 = Library:AddTab("Tộc V4","11162889532")
local P = Library:AddTab("PVP","11446900930")
local R = Library:AddTab("Tập Kích","11446957539")
local T = Library:AddTab("Dịch Chuyển","11155851001")
local S = Library:AddTab("Shop","6031265976")
local D = Library:AddTab("Fruit","11446965348")
local Misc = Library:AddTab("Misc","11446835336")
...
H:AddLabel("Script By Ak Gaming")
H:AddLabel("Seja bem vindo ao AK HUB")

H:AddSeperator("Canal Do Youtube")



H:AddButton("AKRP",function()
setclipboard("https://youtube.com/@akgamingytb999")
end)

H:AddButton("Entre No Servidor Do DISCORD",function()
setclipboard("https://discord.com/invite/4cJerKjx")
end)
...
Main:AddToggle("Điểm xuất hiện tự động",true,function(value)
    _G.Set = value
end)
...
FarmMode = "Normal"
Main:AddDropdown("Chế Độ Farm", ListF,function(value)
    FarmMode = value
end)
...
spawn(function()
  ...
  pcall(function()
    ...
    Main:AddToggle("Tự Động Cày Level",_G.AutoFarm,function(value)
        _G.AutoFarm = value
...
if World1 then
    Main:AddToggle("Tự Đông Farm Nhanh (Farm Sky Lv.10-75)",_G.AutoFarmFast,function(value)
        _G.Farmfast = value
...
Main:AddToggle("Tự Động Nhận Mọi Thứ Trong Trò Chơi",false,function(value)
       _G.AutoFarm = value
...
Main:AddDropdown("Chọn Mob Để Farm",tableMon,function(vu)
    _G.SelectMob = vu
end)
   ...
   Main:AddToggle("Tự Động Farm Không Có Nhiệm Vụ ",_G.AutoFarmNearest,function(value)
...
spawn(function()
    ...
    Main:AddLabel("Tự Động Farm Chest")
    
Main:AddToggle("Tự Động Farm Chest",false,function(value)
 AutoFarmChest = value
...
Main:AddToggle("Tự Động Farm Chest Đảo Bí Ẩn",false,function(value)
...
Main:AddToggle("Tự Động Bypass Chest",false,function(vu)
	_G.ChestBypass = vu
end)
...
Main:AddToggle("Ngừng Farm Chest Khi Nhặt Được Chén Thánh Hoặc Key Râu Đen",_G.STP,function(vu)
	Grab_Chest = vu
...
Main:AddToggle("Tự Động Farm Chest Ở Sever Khác",_G.AutoFarmChest_Hop,function(value)
    _G.AutoFarmChest_Hop = value
    end)


    Main:AddSeperator("KataKuri")
    
local ListC = {"NoQuest", "AcceptQuest", "MasteryFruit"}
CakeFMode = "Accept Quest"
Main:AddDropdown("Chọn Chế Độ Tiêu Diệt Katakuri:", ListC,function(value)
    CakeFMode = value
end)
        ...
        while wait() do
            pcall(function()
                ...
                elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 86 then
                    ...
                    MobKilled:Set("Katakuri spawnado")
                end
            end)
        end
    end)
    
    Main:AddToggle("Tự Động Farm Katakuri",_G.AutoDoughtBoss,function(value)
...
spawn(function()
    ...
    Main:AddToggle("Tự Đông Triệu Hồi Katakuri",true,function(value)
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner",value)
    end)
    
    Main:AddToggle("Tự Động Farm Katakuri v2", _G.Autodoughking,function(value)
         _G.Autodoughking = value
        StopTween( _G.Autodoughking)
    end)
    
    Main:AddToggle("Đổi Sever Farm Katakuri v2", _G.AutodoughkingHop,function(value)
...
local BoSs = Main:AddLabel("Trạng Thái : Chọn Boss")
...
elseif World3 then
    ...
    Main:AddToggle("Tiêu Diệt Boss",_G.AutoFarmBoss,function(value)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
    ...
    Main:AddToggle("Tiêu Diệt Hết Tất Cả Boss",_G.AutoAllBoss,function(value)
        _G.AutoAllBoss = value
        StopTween(_G.AutoAllBoss)
    end)
    
    Main:AddToggle("Đổi Sever Tiêu Diệt Boss",_G.AutoAllBossHop,function(value)
...
Main:AddToggle("BypassTP(reset)",true,function(Fast)
BypassTP = Fast
end)
...
Main:AddToggle("Fast attack",true,function(Fast)
    _G.FastAttackCambodiakak = Fast
end)

Module = require(game:GetService("Players").LocalPlayer.PlayerScripts.CombatFramework)

CombatFrameMai = debug.getupvalues(Module)[2]

spawn(function()
    game:GetService("RunService").RenderStepped:Connect(function()
        if _G.FastAttackCambodiakak then
            if typeof(CombatFrameMai) == "table" then
                pcall(function()
                    CombatFrameMai.activeController.timeToNextAttack = (math.huge^math.huge^math.huge)
                    CombatFrameMai.activeController.timeToNextAttack = 0
                    CombatFrameMai.activeController.hitboxMagnitude = 60
                    CombatFrameMai.activeController.active = false
                    CombatFrameMai.activeController.timeToNextBlock = 0
                    CombatFrameMai.activeController.focusStart = 0
                    CombatFrameMai.activeController.increment = 4
                    CombatFrameMai.activeController.blocking = false
                    CombatFrameMai.activeController.attacking = false
                    CombatFrameMai.activeController.humanoid.AutoRotate = 50
                end)
            end
        end
    end)
    ...
    Main:AddToggle("Fast Attack 2",_G.FastAttack,function(value)
        _G.FastAttack = value
    end)      
...
Main:AddDropdown("Super Fast Attack", AttackList,function(MakoGay)
...
Main:AddToggle("Xoá Thông Báo",true,function(Fast)
_G.Remove_trct = Fast
end)
...
Main:AddToggle("Ẩn Hết Thông Báo",false,function(Remo)
_G.RemoveHit = Remo
end)
...
Main:AddToggle("Ẩn Dame Đánh Quái",false,function(Remo)
...
Main:AddToggle("Màn Hình Treo(đen)",false,function(Umm)
...
spawn(function()
    ...
    spawn(function()
      ...
      if _G.WhiteScreen then
        ...
        Main:AddToggle("Màn Hình Treo(trắng)",_G.WhiteScreen,function(value)
...
elseif _G.WhiteScreen == false then
    ...
    Main:AddToggle("Làm Cho Mob Trở Nên Vô Hình",_G.inv,function(value)
    _G.inv = value
    ...
    Main:AddLabel("Distancia X ")
    Main:AddLabel("Distancia Y ")
    Main:AddLabel("Distancia Z ")


    PosY = 35
    Main:AddSlider("Distancia de Farme ",0,50,35,function(value)
    PosY = value
    end)
    

    Main:AddSeperator("Setting Farm Thông Thạo")
    ...
    if World2 then
        ...
        M:AddToggle("Tự Động Farm Nhà Máy",_G.AutoFactory,function(value)
    ...
    Mirragecheck:Set('🏝️: Ilha Da Miragem esta spawnada')
    else
      Mirragecheck:Set('❌: Ilha Da Miragem Não esta spawnada' )end
            end
        end)
end)
Mirragecheck = M:AddLabel("")
M:AddToggle("Bay Đến Đảo Bí Ẩn",_G.AutoMysticIsland,function(value)
    ...
    M:AddToggle("Tự Động Mua Thuyền ",AutoW,function(W)
    AutoW = W
    end)
    spawn(function()
    while wait() do
    ...
    M:AddToggle("Spawnar Ilha Da Miragem no automatico",_G.dao,function(state)
    if state then
        _G.dao = true
    else
        _G.dao = false
...
M:AddToggle("Dịch Chuyển Tới Npc Bán Trái Cây Trên Đảo",_G.TPNPC,function(value)
             _G.Miragenpc = value
...
M:AddToggle("Nhặt Bánh Range",_G.TweenMGear,function(value)
_G.TweenMGear = value
...
spawn(function()
    ...
    M:AddSeperator("Fighting Styles")
    
    M:AddToggle("Mua Superhuman",_G.AutoSuperhuman,function(value)
        _G.AutoSuperhuman = value
    end)
    ...
    M:AddToggle("Mua DeathStep",_G.AutoDeathStep,function(value)
    ...
    M:AddToggle("Mua Sharkman Karate",_G.AutoSharkman,function(value)
    ...
    M:AddToggle("Mua Electric Claw",_G.AutoElectricClaw,function(value)
    ...
    M:AddToggle("Mua Dragon Talon",_G.AutoDragonTalon,function(value)
    ...
    M:AddToggle("Mua GodHuman",_G.Auto_God_Human,function(value)
				...
				if game.Players.LocalPlayer.Character:FindFirstChild("Superhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Superhuman") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Sharkman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Sharkman Karate") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") or game.Players.LocalPlayer.Character:FindFirstChild("Electro") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electric Claw") or game.Players.LocalPlayer.Character:FindFirstChild("Electric Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Talon") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Talon") or game.Players.LocalPlayer.Character:FindFirstChild("Godhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Godhuman") then
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman",true) == 1 then
						...
						game.StarterGui:SetCore("SendNotification", {
							...
							Icon = "http://www.roblox.com/asset/?id=16799635923",
							Duration = 2.5
						})
					end
...
if World1 or world2 or World3 then    
M:AddToggle("Tự Đông Farm Scrap Metal",false,function(value)
Scrap = value
StopTween(Scrap)
end)
...
if World3 then     
M:AddToggle("Tự Đông Farm Dragon Scale",false,function(value)
Dragon_Scale = value
...
if World3 then     
M:AddToggle("Pegar Rabo de Peixe No automatico",false,function(value)
Fish = value
StopTween(Fish)
end)
...
spawn(function()
    ...
    M:AddToggle("Đổi Sever Farm Nguyên Liệu",_G.Makori_gay,function(value)
    _G.StardHop = value
    end)
   ...
   M:AddSeperator("Mastery Fruit")
    
    M:AddToggle("Farm Thông Thạo Trái",_G.AutoFarmFruitMastery,function(value)
    ...
    M:AddToggle("Farm Thông Thạo Vũ Khí",_G.AutoFarmGunMastery,function(value)
...
function EquipWeaponSword()
    ...
    M:AddToggle("Farmar Maestria De Espada",_G.AutoSwordMastery,function(value)
    ...
    M:AddSeperator("Lấy kiếm Buddy Tự Động ")
    
    M:AddToggle("Lấy Kiếm Buddy Tự Động",_G.AutoBudySword,function(value)
        _G.AutoBudySword = value
        StopTween(_G.AutoBudySword)
    end)
    
    M:AddToggle("Đổi Sever Lấy Kiếm Buddy ",_G.AutoBudySwordHop,function(value)
    ...
    M:AddToggle("Pegar Soul Guitar No Automatico",_G.AutoNevaSoulGuitar,function(value)
...
M:AddToggle("Đổi Sever Lấy Soul Guitar ",false,function(value)
  _G.soulGuitarhop = value    
 end)

 M:AddSeperator("Song Đao Nguyền Rủa")

M:AddToggle("Tự Động Lấy Song Đao Nguyền Rủa ",_G.AutoCdk,function(value)
...
M:AddToggle("Pegar Tushita No Automatico", _G.Autotushita,function(value)
         _G.Autotushita = value
        StopTween( _G.Autotushita)
    end)
    
    M:AddToggle("Pegar Tushita Em Outros Servidores", _G.Autotushitahop,function(value)
    ...
    M:AddToggle("Pegar Cavander No Automatico", _G.AutoCarvender,function(value)
    ...
    M:AddSeperator("Raid Pirata")
    
    M:AddToggle("Pegar Raid Pirata No Automatica", _G.AutoCarvender,function(value)
     _G.RaidPirate = value
    ...
    M:AddToggle("Pegar a Twin Hook No Automatico", _G.AutoTwinHook,function(value)
         _G.AutoTwinHook = value
        StopTween( _G.AutoTwinHook)
    end)
    
    M:AddToggle("Pegar a Twin Hook em Outros Servidor", _G.AutoTwinHook_Hop,function(value)
...
M:AddToggle("MATAR TERRORSHARK",_G.Makori_gay,function(value)
...
M:AddToggle("MATAR TUBARÕES PEQUENOS",_G.Makori_gay,function(value)
_G.bjirShark = value
...
spawn(function()
    ...
    M:AddToggle("MATAR PIRANHAS",_G.Makori_gay,function(value)
...
spawn(function()
        ...
        M:AddToggle('MATAR NAVIO FANTASMA', _G.bjirFishBoat, function(value)
...
M:AddToggle('PEGAR A SHARK Anchor', _G.BjirAnchorCuy, function(state)
...
elseif state and (not findItem("Monster Magnet", 1) or not findItem("Terror Eyes", 2) and not findItem("Electric Wing", 8) and not findItem("Fool's Gold", 20) and not findItem("Shark Tooth", 10)) then
    ...
    game.StarterGui:SetCore("SendNotification", {
        Icon = "rbxassetid://15882149221",
        Title = "CALMA LA MEU MANO", 
        Text = "TU precisa de mais materiais para fazer o Monster Magnet."
    })
else
    _G.BjirAnchorCuy = false
end
...
spawn(function()
    ...
    M:AddToggle("ANDAR PELO MAR",_G.BiirTrax,function(state)
    if state then
        _G.BiirTrax = true
    else
        _G.BiirTrax = false
...
spawn(function()
    ...
    pcall(function()
        while wait() do
            if game.Workspace._WorldOrigin.Locations:FindFirstChild('Frozen Dimension') then
                FrozenIsland:Set('🟢: Leviatã Spawnado')
            else
                FrozenIsland:Set('🔴: Leviatã não está por aqui')
            end
        end
    end)
end)
    ...
    pcall(function()
        while wait() do
            if game.Workspace._WorldOrigin.Locations:FindFirstChild('Kitsunen Island') then
                FaiFaoKai:Set('🦊: Kitsune Spwanada')
            else
                FaiFaoKai:Set('🔴: Kitsune não está por aqui')
            end
        end
    end)
end)
...
FrozenIsland = M:AddLabel("")
    ...
    M:AddToggle("Teleport para kitsune island",_G.AutoFKitsune,function(value)
    _G.AutoFKitsune = value
    StopTween(_G.AutoFKitsune)
    end)
    
    M:AddToggle("Coletar Azure Ember",_G.AutoAzuerEmber,function(value)
    ...
    M:AddToggle("notificador de kitsune island",_G.KisuneWarn,function(value)
    _G.KisuneWarn = value
    end)
...
notification.SoundId = "rbxassetid://15882149221" --sound id
notification.Volume = 5 --ระวังหูแตก
            ...
            if _G.KisuneWarn then
                pcall(function()
                    if game.Workspace._WorldOrigin.Locations:FindFirstChild('Kitsune Island') then
                        wait(5)
                    game.StarterGui:SetCore("SendNotification", {
                        Icon = "http://www.roblox.com/asset/?id=15882149221";
                        Title = "Yago hub Notification", 
                        Text = "Kitsune Spawnada 🦊";
                    notification:Play()
                    })
                    end
                end)
...
local countdown = 600 -- 10 minutos em segundos
local timerActive = false

local function formatTime(seconds)
	local minutes = math.floor(seconds / 60)
	local secondsRemaining = seconds % 60
	return string.format("%dmin %02ds", minutes, secondsRemaining)
end

spawn(function()
	while true do
		pcall(function()
			local eliteFound = game:GetService("ReplicatedStorage"):FindFirstChild("Diablo [Lv. 1750]") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre [Lv. 1750]") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Urban [Lv. 1750]")

			if eliteFound then
				Elite_Hunter_Status:Set("Status: Elite Spawnado!")
				timerActive = false
			else
				if not timerActive then
					timerActive = true
					countdown = 600 -- Reinicia o timer de 10 minutos
				end

				Elite_Hunter_Status:Set("Status: Contagem regressiva - " .. formatTime(countdown))

				countdown = countdown - 1

				if countdown <= 0 then
					Elite_Hunter_Status:Set("Status: Elite Não Esta Spawnado")
					timerActive = false
				end
			end
		end)
...
spawn(function()
	while wait() do
		Total_Elite_Hunter:Set("Quantidade de Elite Hunter que Você Derrotou: " .. game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter", "Progress"))
	end
end)

	
    M:AddToggle("Farmar Elite Hunter No Automatico",_G.AutoElitehunter,function(value)
    ...
    M:AddToggle("Farmar Elite Hunter Em Outros Servidores",_G.AutoEliteHunterHop,function(value)
        _G.AutoEliteHunterHop = value
    end)
    
    M:AddSeperator("Matar Buneco De Treino")
    
    M:AddToggle("Matar Buneco De Treino No Automatico",_G.AutoArenaTrainer,function(value)
    _G.Namfon = value
    StopTween(_G.Namfon)
    end)
	...
	M:AddToggle("Matar Buneco De Treino Trocando De Server",_G.AutoArenaTrainerHop,function(value)
        _G.AutoArenaTrainerHop = value
    end)
    
    M:AddSeperator("Foice Amaldiçoada")
    
    M:AddToggle("Farmar Foice Amaldiçoada No Automatico",_G.AutoFarmBossHallow,function(value)
        _G.AutoFarmBossHallow = value
        StopTween(_G.AutoFarmBossHallow)
    end)
    
    M:AddToggle("Farmar Foice Amaldiçoada Em outro Servidor",_G.AutoFarmBossHallowHop,function(value)
    ...
    M:AddSeperator("Mini Yoru")
    
    M:AddToggle("Farmar Mini Yoru (matar Rip Indra)",_G.AutoDarkDagger,function(value)
    ...
    M:AddToggle("Farmar Mini Yoru (matar Rip Indra) Em outro servidor",_G.AutoDarkDagger_Hop,function(value)
...
M:AddToggle("Ativar Os Hakis Lendarios",_G.Farm_Ob_Color,function(vu)
	Open_Color_Haki = vu
...
function EquipAllWeapon()
    ...
    M:AddSeperator(" Eventos Do Mar ")
 
    M:AddToggle('Teleportar Aos Seabaeast', false, function(value)
...
M:AddToggle("Matar Seabaeast No Automatico",_G.Auto_Seabest,function(value)
...
M:AddToggle("Comprar Barco Quando Ele For Destruido",_G.AutoDesBoat,function(value)
...
M:AddToggle('Farmar Raid Barco', false, function(value)
    PirateShip = value
    end)
spawn(function()
        while wait() do
...
M:AddToggle('Mudar de server Para Farme Maritima', false, function(value)
    _G.AutoSeaBestHop = value
    end)
    
    
    M:AddSeperator(" Tridentes ")
	
	M:AddToggle("Pegar Dragon Trident No automatico", _G.Auto_Dragon_Trident,function(value)
         _G.Auto_Dragon_Trident = value
        StopTween(_G.Auto_Dragon_Trident)
    end)
    
    M:AddToggle("Pegar Dragon Trident Em outro Server", _G.Auto_Dragon_Trident_Hop,function(value)
	...
	M:AddSeperator(" Waden ")
	
	M:AddToggle("Pegar Waden No Automatico", _G.Autowaden,function(value)
         _G.Autowaden = value
        StopTween( _G.Autowaden)
    end)
    
    M:AddToggle("Pegar Waden Em Outro servidor", _G.Autowadenhop,function(value)
    ...
    M:AddSeperator(" Barba Branca ")
    
    M:AddToggle("Matar Greybeard No automatico", _G.Autodoughking,function(value)
         _G.Autogay = value
        StopTween( _G.Autogay)
    end)
    
    M:AddToggle("Matar Greybeard Em outros Servidores", _G.AutodoughkingHop,function(value)
         _G.Autogayhop = value
    end)
    ...
    M:AddToggle("Pegar Pole v1 no Automatico", _G.Autodoughking,function(value)
         _G.Autopole = value
        StopTween( _G.Autopole)
    end)
    
    M:AddToggle("Pegar Pole v1 em outros Servidores", _G.AutodoughkingHop,function(value)
...
local PolePos = CFrame.new(-7748.0185546875, 5606.80615234375, -2305.898681640625)
    ...
    M:AddSeperator("Swan Glasses")
    
    M:AddToggle("Pegar Oculos Do Doflamingo no Automatico",_G.AutoFarmSwanGlasses,function(value)
    ...
    M:AddToggle("Pegar Oculos Do Doflamingo Em outro Servidor",_G.AutoFarmSwanGlasses_Hop,function(value)
        _G.AutoFarmSwanGlasses_Hop = value
    end)
    
    M:AddSeperator("Sharks Saw")
    
    M:AddToggle("Pegar Sharks Saw No Automatico", _G.Autodoughking,function(value)
         _G.Autosaw = value
        StopTween( _G.Autosaw)
    end)
    
    M:AddToggle("Pegar Sharks Saw em outro Servidor", _G.AutodoughkingHop,function(value)
         _G.Autosawhop = value
    end)
    ...
    M:AddSeperator("Farme Bone")
    
    BoneCheck = M:AddLabel("Quantos Bone Eu tenho :  ")
...
M:AddDropdown("Selecionar Modelo De Farmar Bones", ListB,function(value)
    BoneFMode = value
end)

    local BoneFarm = M:AddToggle("Farmar Bone No Automatico",_G.Auto_Bone,function(value)
        _G.Auto_Bone = value
   ...
   local BonePos = CFrame.new(-9506.234375, 172.130615234375, 6117.0771484375)
    ...
    M:AddSeperator("Haki Da Observação")
    ...
    M:AddToggle("Treinar Haki Da Observação",_G.AutoObservation,function(value)
    ...
    M:AddToggle("Treinar Haki Da Observação Trocando De Servidor",_G.AutoObservation_Hop,function(value)
    ...
    M:AddToggle("Pegar Saber No Automatico",_G.AutoSaber,function(value)
				_G.Auto_Saber = value
				StopTween(_G.Auto_Saber)
			end)
			
			M:AddToggle("Pegar Saber Em Outros Servidores",_G.AutoSaberHop,function(value)
 ...
 spawn(function()
    ...
    M:AddSeperator("Espadas Lendarias")
    ...
    pcall(function()
        while wait() do
            ...
            elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("LegendarySwordDealer","3") then
                ...
                LegendSwords:Set("Vendedor nâo Spawnado")
            end
        end
    end)
end)
...
LegendSwords = M:AddLabel("StatusCheck")
    ...
    M:AddToggle("Pegar Espadas Lendarias No Automatico",_G.AutoBuyLegendarySword,function(value)
        _G.AutoBuyLegendarySword = value
    end)
    ...
    M:AddToggle("Pegar Espadas Lendarias Em Outros Servidores",_G.AutoBuyLegendarySword_Hop,function(value)
        _G.AutoBuyLegendarySword_Hop = value
    end)
    
    M:AddSeperator("Cor De Haki")
    ...
    pcall(function()
        while wait() do
            if game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer("ColorsDealer", "1") then
                ...
                ColorHaki:Set("Vendedor nâo Spawnado")
            end
        end
    end)
end)
...
ColorHaki = M:AddLabel("เช็กแปป...พบว่า Koben แจกตัวรัน Synx ทีมีไวรัสฟรี")
    ...
    M:AddToggle("Pegar Cor De Haki No Automatico",_G.AutoBuyEnchancementColour,function(value)
        _G.AutoBuyEnchancementColour = value
    end)
    
    M:AddToggle("Pegar Cor De Haki Em outros Servidor",_G.AutoBuyEnchancementColour_Hop,function(value)
    ...
    M:AddSeperator("Outros")
    
    M:AddToggle("Pegar Musketeer No Automatico",_G.AutoMusketeerHat,function(value)
    ...
    M:AddToggle("Pegar Rainbow Haki No Automatico",_G.Auto_Rainbow_Haki,function(value)
    ...
    M:AddToggle("Pegar Haki Da Observação v2",_G.AutoObservationv2,function(value)
    ...
    M:AddToggle("Pegar Rengoku No Automatico",_G.AutoRengoku,function(value)
    ...
    M:AddToggle("Farmar Ectoplasma no Automatico",_G.AutoEctoplasm,function(value)
    ...
    M:AddToggle("Pegar Yama No Automatico",_G.AutoYama,function(value)
        _G.AutoYama = value
    ...
    M:AddToggle("Pegar Raça (V2) No Automarico",_G.Auto_EvoRace,function(value)
    ...
    M:AddToggle("Fazer Bartlio Quest No Automatico ",_G.AutoBartilo,function(value)
    ...
    M:AddToggle("Fazer A Missão Da Tocha no Automatico",_G.AutoHolyTorch,function(value)
...
Ss:AddToggle("Status Automaticos Feitos Poi I.a",_G.Auto_Stats_Kaitun,function(value)
_G.Auto_Stats_Kaitun = value
end)
...
Ss:AddToggle("Soco",false,function(Value)
melee = Value    
end)
Ss:AddToggle("Defensa",false,function(value)
defense = value
end)
Ss:AddToggle("Espada",false,function(value)
sword = value
end)
Ss:AddToggle("Arma",false,function(value)
gun = value
end)
Ss:AddToggle("Fruta",false,function(value)
demonfruit = value
end)
...
RaceV4:AddButton("Teleporte ao Topo Da Grande Arvore",function()
  topos(CFrame.new(2947.556884765625, 2281.630615234375, -7213.54931640625))
    end)
    
    RaceV4:AddButton("Teleporte ao Templo do Tempo",function()
  Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
    end)
    
RaceV4:AddButton("Teleporte ao Lever Pull",function()
  topos(CFrame.new(28575.181640625, 14936.6279296875, 72.31636810302734))
end)

RaceV4:AddButton("Teleporte Ao Acient One",function()
  topos(CFrame.new(28981.552734375, 14888.4267578125, -120.245849609375))
end)
   
   RaceV4:AddButton("Abaixar Alavanca.", function()
...
RaceV4:AddButton("Liberar Acesso ao relógio", function()
    game:GetService("Workspace").Map["Temple of Time"].DoNotEnter:Remove()
    game:GetService("Workspace").Map["Temple of Time"].ClockRoomExit:Remove()
end)

RaceV4:AddToggle("Comprar Engrenagem No Automatico",_G.Auto_Farm_Bone4,function(value)
...
RaceV4:AddToggle("Travar Mira Na Lua",false,function(v)
  _G.AutoDooHee = v
  end)
spawn(function()
    while wait() do
...
RaceV4:AddToggle("Liberar Treino Da Raça v4",_G.AutoRace,function(value)
 _G.AutoRace = value
 StardFarm = value
...
RaceV4:AddToggle("Desabilitar Escadas Infinitas", nil, function(value)
	game.Players.LocalPlayer.Character.InfiniteStairs.Disabled = value
end)

 
  RaceV4:AddButton("Teleporte A Porta Da Cyborg",function()
  topos(CFrame.new(28492.4140625, 14894.4267578125, -422.1100158691406))
  end)
  
  RaceV4:AddButton("Teleporte A Porta Da Shark",function()
  topos(CFrame.new(28224.056640625, 14889.4267578125, -210.5872039794922))
  end)
  
  RaceV4:AddButton("Teleporte A Porta Da Ghoul",function()
  topos(CFrame.new(28672.720703125, 14889.1279296875, 454.5961608886719))
  end)
  
  RaceV4:AddButton("Teleporte A Porta Da Humano",function()
  topos(CFrame.new(29237.294921875, 14889.4267578125, -206.94955444335938))
  end)
  
  RaceV4:AddButton("Teleporte A Porta Da Mink",function()
  topos(CFrame.new(29020.66015625, 14889.4267578125, -379.2682800292969))
  end)
  
  RaceV4:AddButton("Teleporte A Porta Da Sky",function()
  topos(CFrame.new(28967.408203125, 14918.0751953125, 234.31198120117188))
  end)

  RaceV4:AddSeperator("Completar Triais No Automatico")
  
  RaceV4:AddButton("Comprar Treino no Ancient One",function(t)
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer('UpgradeRace','Buy')
  end)
  RaceV4:AddToggle("Matar Playeres No Trial",false,function(Val)
  _G.AutoKillTial = Val
  StopTween(_G.AutoKillTial)
  end)
  RaceV4:AddToggle("Fazer Trail No Automatico",false,function(v)
  _G.AutoQuestRace = v
...
spawn(function()
 ...
 RaceV4:AddButton("Fazer Trial Da Angel No Automatico",function(t)
        topos(game.Workspace.Map.SkyTrial.Model.FinishPart.CFrame)
        end)

        RaceV4:AddButton("Fazer Trial Da Mink No Automatico",function(t)
        topos(game:GetService("Workspace").Map.MinkTrial.Ceiling.CFrame * CFrame.new(0,-5,0))
        end)

        RaceV4:AddButton("Fazer Trial Da Cyborg No Automatico",function(t)
    ...
    local SelectedPly = P:AddDropdown("Selecionar Jogadores",Playerslist,function(value)
        _G.SelectPly = value
    end)
    
    P:AddButton("Atualizar Lista De Jogadores",function()
        Playerslist = {}
        SelectedPly:Clear()
        for i,v in pairs(game:GetService("Players"):GetChildren()) do  
    ...
    P:AddToggle("Encontrar Jogador [Obter a visão dele]",false,function(value)
        SpectatePlys = value
    ...
    P:AddToggle("Teleportar ao jogador selecionado",false,function(value)
    ...
    P:AddToggle("Teleportar Instantaneamente jogador",false,function(bool)
                                    _G.Teleport = bool
    ...
    P:AddToggle("Matar Players Automaticamente",false,function(value)
    ...
    P:AddButton("Agrupar Players em um unico lugar [Use o Electric Claw]",function()
    ...
    P:AddSeperator("Missão de Matar Players [estar como marinha]")
    
    P:AddButton("Matar Players Com Missão de elite",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("PlayerHunter")
    end)
    
    P:AddToggle("Matar Jogador da Missão",_G.AutoPlayerHunter,function(Killzps)
    ...
    P:AddToggle("Aimbot da Arma",false,function(value)
        _G.Aimbot_Gun = value
    end)
...
spawn(function()
    ...
    P:AddToggle("Ativar PvP",false,function(value)
        _G.EnabledPvP = value
    end)
    ...
    P:AddToggle("Modo Seguro",false,function(value)
        _G.Safe_Mode = value
    ...
    local Current = P:AddLabel("Quanto de Bounty Eu tenho :")
    ...
    spawn(function()
        while wait() do
            pcall(function()
                ...
                Earn:Set("quanto eu ganhei: "..tonumber(Earned1))
            end)
        end
    end)
    
    P:AddToggle("Farmar Bounty",_G.AutoFarmBounty,function(value)
    ...
    P:AddToggle("Farmar Bounty Mudando de server",_G.AutoFarmBounty_Hop,function(value)
    ...
    local TimeRaid = R:AddLabel("Andamendo Da Raid")
    
    local Island1 = R:AddLabel(": Ilha 1")
    local Island2 = R:AddLabel(": Ilha 2")
    local Island3 = R:AddLabel(": Ilha 3")
    local Island4 = R:AddLabel(": Ilha 4")
    local Island5 = R:AddLabel(": Ilha 5")
        ...
        pcall(function()
            while wait() do
                if game:GetService("Players").LocalPlayer.PlayerGui.Main.Timer.Visible == true then
                    ...
                    TimeRaid:Set("Andamendo Da Raid")
                end
            end
        end)
    end)
...
spawn(function()
    ...
    Island5:Set('✅: Ilha 5')
      ...
      Island5:Set('❌: Ilha 5' )end
            end
        end)
end)
    
        R:AddToggle("Ir Para Próxima Ilha Automaticamente",_G.Auto_Dungeon,function(value)
...
spawn(function()
    ...
    R:AddToggle("Deixar Fruta Awakener Automaticamente",_G.Auto_Awakener,function(value)
...
spawn(function()
    ...
    R:AddDropdown("Selecione O MicroChip",Raidslist,function(value)
        _G.SelectChip = value
    end)
    
    R:AddToggle("Confirmar MicroChip Selecionado",_G.AutoSelectDungeon,function(value)
    ...
    R:AddToggle("Comprar MicroChip",_G.AutoBuyChip,function(value)
    ...
    R:AddButton("Comprar MicroChi Selecionado",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("RaidsNpc","Select",_G.SelectChip)
    end)
    
    R:AddToggle("Iniciar Raid Automaticamente",_G.Auto_StartRaid,function(value)
    ...
    R:AddButton("Iniciar Raid",function()
        if World2 then
            fireclickdetector(game:GetService("Workspace").Map.CircleIsland.RaidSummon2.Button.Main.ClickDetector)
        elseif World3 then
            fireclickdetector(game:GetService("Workspace").Map["Boat Castle"].RaidSummon2.Button.Main.ClickDetector)
        ...
        R:AddButton("Próxima ilha",function()
        pcall(function()
            if game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5") then
    ...
    R:AddSeperator("KoKo Sword")
    
 R:AddToggle("Pegar Espada Do Law Automaticamente", _G.AutoOderSword,function(value)
     _G.AutoOderSword = value
    StopTween( _G.AutoOderSword)
    end)
    
    R:AddToggle("Pegar Espada Do Law em Outro server", _G.AutoOderSwordHop,function(value)
    ...
    R:AddButton("Comprar Microchip Raid Law",function()
    local args = {
       [1] = "BlackbeardReward",
       [2] = "Microchip",
       [3] = "2"
    ...
    R:AddButton("Iniciar Raid Law",function()
        if World2 then
            fireclickdetector(game:GetService("Workspace").Map.CircleIsland.RaidSummon.Button.Main.ClickDetector)
        end
    end)

    T:AddSeperator("Mundos")
    
    T:AddButton("Teleporte Ao Primeiro mundo",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
    end)
    
    T:AddButton("Teleporte Ao Segundo mundo",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
    end)
    
    T:AddButton("Teleporte Ao Terceiro mundo",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
    end)
    ...
    T:AddSeperator("Ilhas")
    
    if World1 then
        T:AddDropdown("Selecionar Ilha",{
            "WindMill",
            "Marine",
            "Middle Town",
            "Jungle",
...
if World1 then
	T:AddDropdown("Selecionar Teleport Instantaneo",{
		"WindMill",
		"Marine",
		"Middle Town",
		"Jungle",
...
T:AddButton("Teleporte instantaneo",function(value)
    ...
    S:AddSeperator("Habilidades")
    
    S:AddButton("Comprar Geppo [ $10,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Geppo")
    end)
    
    S:AddButton("Comprar Haki Do Armamento [ $25,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Buso")
    end)
    
    S:AddButton("Comprar Soru [ $25,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Soru")
    end)
    
    S:AddButton("Comprar Haki da Observação[ $750,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("KenTalk","Buy")
    end)
    
S:AddToggle("Comprar Habilidades", false, function(t)
    Abilities = t
...
S:AddDropdown("Selecionar Barcos",BoatList,function(value)
    SelectBoat = value
end)

S:AddButton("Comprar Barco",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyBoat",_G.SelectBoat)
end)

    S:AddSeperator("Estilos De Luta")
    
    S:AddButton("Comprar Black Leg [ $150,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyBlackLeg")
    end)
    
    S:AddButton("Comprar Electro [ $550,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectro")
    end)
    
    S:AddButton("Comprar Fishman Karate [ $750,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyFishmanKarate")
    end)
    
    S:AddButton("Comprar Dragon Claw [ $1,500 Fragments ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","1")
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","2")
    end)
    
    S:AddButton("Comprar Superhuman [ $3kk Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman")
    end)
    
    S:AddButton("Comprar Death Step [ $5k Fragments $5kk Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep")
    end)
    
    S:AddButton("Comprar Sharkman Karate [ $5k Fragments $2,5kk Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate",true)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate")
    end)
    
    S:AddButton("Comprar Electric Claw [ $5k Fragments $3kk Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw")
    end)
    
    S:AddButton("Comprar Dragon Talon [ $5k Fragments $3kk Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon")
    end)

    S:AddButton("Comprar God Human [ $5k Fragments $5kk Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyGodhuman")
    end)
    -----Shop----------------
    
    S:AddSeperator(" Espadas ")
    ...
    S:AddButton("Girar Oso [ $50 Bone ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Buy",1,1)
    end)
    
    S:AddButton("Reiniciar Status [ $50 Bone ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Buy",1,2)
    end)
        
    S:AddButton("Giro De Raça [ $50 Bone ]",function()
...
S:AddButton("Reiniciar Statuss (Usa 2.5K Fragmentos)", function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","1")
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","2")
end)

S:AddButton("Giro De Raça (Usa 3K Fragmentos)", function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Reroll","1")
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Reroll","2")
end)
    --------------Accessorios-----------------
    	S:AddSeperator("⚙️ Accessorios ⚙️")
   ...
   D:AddSeperator("Fruit Sniper")
    ...
    _G.SelectFruit = ""
    D:AddDropdown("Selecionar Fruta Desejada",Table_DevilFruitSniper,function(value)
        _G.SelectFruit = value
    end)
    
    D:AddToggle("Comprar Fruita Desejada",_G.AutoBuyFruitSniper,function(value)
        _G.AutoBuyFruitSniper = value
    end)
    
    
    D:AddToggle("Girar Frutas Automaticamente",_G.Random_Auto,function(value)
        _G.Random_Auto = value
    end)
    ...
    D:AddButton("Girar Frutas",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Cousin","Buy")
    end)
    
        D:AddButton("Abrir Loja De Frutas",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
        game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitShop.Visible = true
    end)
    
    D:AddToggle("Jogar Frutas Fora",_G.DropFruit,function(value)
        _G.DropFruit = value
    end)
    ...
    D:AddToggle("Guardar Frutas",_G.AutoStoreFruit,function(value)
        _G.AutoStoreFruit = value
    end)
...
spawn(function()
    ...
    D:AddToggle("Notificador de Fruitas",_G.Grabfruit,function(value)
    _G.FruitCheck = value
    end)
    ...
    D:AddToggle("Teleporte Para as Frutas",_G.Tweenfruit,function(value)
    _G.Tweenfruit = value
    ...
    spawn(function()
        ...
        D:AddToggle("Teleporte Para as Frutas Instantaneo [Risco de Fazer o L]",_G.BringFruitBF,function(value)
    ...
    Misc:AddButton("Relogar O Server",function()
        game:GetService("TeleportService"):Teleport(game.PlaceId, game:GetService("Players").LocalPlayer)
    end)
    
    Misc:AddButton("Entrar Em Servidor Semi Privado",function()
        Hop()
    end)
    
    Misc:AddButton("Entrar Em um Servidor vazio",function()
    ...
    Misc:AddButton("Copiar Id do Servidor",function()
	setclipboard(tostring(game.JobId))
	end)
	
    Misc:AddTextbox("COLAR Id DO SERVIDOR", true, function(value)
	_G.Job = value
	end)

	Misc:AddButton("ENTRAR NO SERVER [BETA]",function()
    ...
    Misc:AddButton("Abrir Loja De Fruta",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
        game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitShop.Visible = true
    end)
    
    Misc:AddButton("Abrir Inventario",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventoryWeapons")
        wait(1)
        game:GetService("Players").LocalPlayer.PlayerGui.Main.Inventory.Visible = true
    end)
    
    Misc:AddButton("Abrir Inventario de Frutas",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventoryFruits")
        game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitInventory.Visible = true
    end)
    
    Misc:AddButton("Abrir Titulos",function()
    local args = {
        [1] = "getTitles"
    }
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
...
Misc:AddButton("Colores De Haki",function()
    game.Players.localPlayer.PlayerGui.Main.Colors.Visible = true
end)
      
Misc:AddSeperator("Times")
    
    Misc:AddButton("Entrar Como Pirata",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","Pirates") 
    end)
    
    Misc:AddButton("Entrar Como Marinha",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","Marines") 
    end)
    
    Misc:AddSeperator("Highlight")

Misc:AddToggle("Remover Chat", _G.chat, function(value)
    _G.chat = value
...
StarterGui:SetCoreGuiEnabled(Enum.CoreGuiType.Chat, true)    
  ...
  Misc:AddToggle("Remover Lista De Bounty", _G.leaderboard, function(a)
    _G.leaderboard = a
...
game:GetService('StarterGui'):SetCoreGuiEnabled(Enum.CoreGuiType.PlayerList, true)   
    ...
    Misc:AddToggle("Modo Highlight",false,function(value)
        if value == true then
            game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Beli.Visible = false
            game:GetService("Players")["LocalPlayer"].PlayerGui.Main.HP.Visible = false
            game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Energy.Visible = false
...
Misc:AddToggle("Graficos",false,function(v)
			if v then
	...
	Misc:AddToggle("Visão De Raio X",false,function(value)
		NoWorld = value
...
repeat wait() until game:IsLoaded() 
	...
	Misc:AddToggle("Relogar O Server A Cada 30 Minutos",true,function(value)
		_G.AutoRejoin = value
	end)
	...
	Misc:AddToggle("Travar Level",false,function(value)
		_G.LockLevel = value
	end)
...
Misc:AddSlider("Select Level Lock Farm",1,LockLevelValue,LockLevelValue,nil,function(value)
	...
	Misc:AddToggle("Travar Beli",false,function(value)
		_G.LockBeli = value
	end)
	...
	Misc:AddTextbox("Travar Beli", true, function(value)
		_G.LevelcloseBeli = value
	end)

	Misc:AddToggle("Travar Fragmentos",false,function(value)
		_G.LockFragments = value
	end)

	Misc:AddSlider("Travar Fragmentos",0,_G.LevelcloseFragments,_G.LevelcloseFragments,100000,function(value)
	...
	Misc:AddSlider("Travar Bone",1,5000,100,_G.Lock_Bone,_G.Lock_Bone,function(value)
		_G.Lock_Bone = value
	end)
	
	Misc:AddLabel('Travar Maestria')
...
_G.LockSle = value
    ...
    Misc:AddToggle("Inciar Bloqueio",lock,function(value)
        _G.KobenHubLek = value
    end)
    
    LockPls = 600
    Misc:AddSlider(" Espulsar quando a Maestria Alcançar",0,600,600,function(value)
    LockPls = value
    end)
    ...
    Misc:AddButton("Resgatar Codigos",function()
    ...
    Misc:AddDropdown("Selecionar Codigos",{"NOOB_REFUND","SUB2GAMERROBOT_RESET1","Sub2UncleKizaru"},function(value)
        _G.CodeSelect = value
    end)
    
    Misc:AddButton("Resgatar Codigo Selecionado",function()
        game:GetService("ReplicatedStorage").Remotes.Redeem:InvokeServer(_G.CodeSelect)
    end)
    
    Misc:AddSeperator("Estado")
    
    Misc:AddDropdown("Selecionar Estado Do Haki",{"State 0","State 1","State 2","State 3","State 4","State 5"},function(value)
        _G.SelectStateHaki = value
    end)
    
    Misc:AddButton("Ativar Estado Do Haki",function()
    ...
    Misc:AddSeperator("Graficos")

    
    Misc:AddButton("Melhorar o FPS",function()
        pcall(function()
    ...
    Misc:AddButton("Remover Fumaças",function(qww)
	game:GetService("Lighting").LightingLayers:Destroy()
	game:GetService("Lighting").Sky:Destroy()
end)
    
Misc:AddToggle("Remover Fumaças",RemoveFog,function(value)
    RemoveFog = value
    ...
    Misc:AddButton("Sempre De Dia",function()
    game:GetService("RunService").Heartbeat:wait() do
        game:GetService("Lighting").ClockTime = 12
    end
    end)
    
    Misc:AddToggle("Remover dano",function()
    ...
    Misc:AddButton("Tirar Limitador De Fps",function()
        setfpscap(9999999)
    end)
    
    Misc:AddButton("Gastar Menos CPU", function()
...
Misc:AddSeperator("Localizadores")
    
    Misc:AddToggle("Localizar Players",false,function(a)
        ESPPlayer = a
	UpdatePlayerChams()
    end)
    
    Misc:AddToggle("Localizar Baus",false,function(a)
        ChestESP = a
	UpdateChestChams() 
    end)
    
    Misc:AddToggle("Localizar Frutas",false,function(a)
        DevilFruitESP = a
    ...
    Misc:AddToggle("Localizar Frutas Reais",RealFruitESP,function(a)
        RealFruitESP = a
	UpdateRealFruitChams() 
    end)
    
    Misc:AddToggle("Localizar Flores",false,function(a)
        FlowerESP = a
	UpdateFlowerChams() 
    end)
    spawn(function()
...
Misc:AddToggle("Localizar Ilhas",IslandESP,function(value)
        IslandESP = value
        while IslandESP do wait()
            UpdateIslandESP() 
        end
    end)
    Misc:AddToggle("Localizar NPC", false, function(nec)
    NpcESP = nec
end)

Misc:AddToggle("Localizar Sea Beast", false, function(nec)
    SeaESP = nec
end)


Misc:AddToggle("Localizar Mob", false, function(nec)
    MobESP = nec
end)

Misc:AddToggle("Localizar Ilha Da Miragem", false, function(value)
...
Misc:AddToggle("Localizar Vendedor de Fruta Avancado", false, function(value)
    AfdESP = value
...
Misc:AddToggle("Localizar Engrenagem", false, function(value)
    GearESP = value
    ...
    Misc:AddSeperator("Habilidades")
    
    Misc:AddToggle("Sem Cooldown",false,function(value)
        nododgecool = value
        NoDodgeCool()
    end)
    
    Misc:AddToggle("Energia Infinita",false,function(value)
        InfiniteEnergy = value
        originalstam = LocalPlayer.Character.Energy.Value
    end)
    
    Misc:AddToggle("Ativar Raça",_G.AutoAgility,function(value)
    ...
    Misc:AddToggle("Habilidades Infinitas",true,function(value)
        InfAbility = value
        if value == false then
            game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility"):Destroy()
        end
    ...
    Misc:AddToggle("Use Awakening Automaticamente",_G.AutoAwakeningRace,function(value)
    ...
    Misc:AddToggle("Range Da Obsevação Infinito",getgenv().InfiniteObRange,function(value)
    ...
    Misc:AddToggle("Geppo Infinito",getgenv().InfGeppo,function(value)
    ...
    Misc:AddToggle("Soru Infinito",getgenv().InfSoru,function(value)
    ...
    Misc:AddToggle("Andar Sobre A Agua",true,function(value)
        _G.WalkWater = value
    end)
    ...
    Misc:AddToggle("Intangivel",_G.NOCLIP,function(value)
        _G.NOCLIP = value
    end)
    ...
    Misc:AddButton("Remover Dano da Lava",function()
		for i,v in pairs(game.Workspace:GetDescendants()) do
			if v.Name == "Lava" then   
				v:Destroy()
			end
...
print("/console pls")
print("For Skid Reskin i Hua Kuy ")

game.StarterGui:SetCore("SendNotification", {
      Icon = "http://www.roblox.com/asset/?id=15498317188";
      Title = "Yago Hub", 
      Text = "Bem vindo ao Yago Hub";
})
wait(3)
game.StarterGui:SetCore("SendNotification", {
      Icon = "http://www.roblox.com/asset/?id=15498317188";
      Title = "Yago Hubb", 
      Text = "Script By Pokas🐗🐗";
})
